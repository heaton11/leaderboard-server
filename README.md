# Leaderboard Server [![CodeFactor](https://www.codefactor.io/repository/github/heaton11/leaderboard-server/badge)](https://www.codefactor.io/repository/github/heaton11/leaderboard-server)
