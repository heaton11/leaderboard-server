...
declare const LeaderboardApplication_base: (new (...args: any[]) => {
    projectRoot: string;
    ...
    prependOnceListener: (event: string | symbol, listener: (...args: any[]) => void) => import("@loopback/core").Application;
    eventNames: () => (string | symbol)[];
}) & typeof WebsocketApplication;
export declare class LeaderboardApplication extends LeaderboardApplication_base {
